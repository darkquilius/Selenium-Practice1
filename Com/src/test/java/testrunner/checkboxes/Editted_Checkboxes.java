...
public class Editted_Checkboxes implements WebDriver_Methods {
	...
	public void I_change_the_default_settings_for_each_box() {
	...
	public void the_first_box_is_enabled() {
		Assert.assertTrue(checkboxes.get(0).isSelected());
	}
	
	@And("the second box is not enabled")
	public void the_second_box_is_not_enabled() {
